...
function playRound(humanChoice, computerChoice) {
    ...
    if (humanChoice === computerChoice) {
        thisRound.textContent = `Draw! You both chose ${computerChoice}`;
    }
    // Win Scenario
    else {
        if (humanChoice === "rock" && computerChoice === "scissors" ||
            ...
            thisRound.textContent = `You win this round! ${humanChoice} beats ${computerChoice}`;
            humanScore++;
        }
        else if (computerChoice === "rock" && humanChoice === "scissors" ||
            computerChoice === "paper" && humanChoice === "rock" ||
            computerChoice === "scissors" && humanChoice === "paper") {
            thisRound.textContent = `You lose this round! ${computerChoice} beats ${humanChoice}`;
            computerScore++;
        }
    }
